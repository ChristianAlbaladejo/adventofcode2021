                ...
                for columns, rows in board_values_dict.items():
                    ...
                    for number in rows:
                        if drawn_numbers[drawn] == rows[z]:
                            rows[z] = 100
                            if rows.count(100) == 5 or int(board_values_dict[0][z]) + int(
                                    board_values_dict[1][z]) + int(board_values_dict[2][z]) + int(
                                    board_values_dict[3][z]) + int(board_values_dict[4][z]) == 500:
                                result = 0
                                last = int(number)
